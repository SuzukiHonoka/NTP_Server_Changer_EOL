...
public class MiClockView extends View {
    ...
    public MiClockView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        /* 背景色 */
        int mBackgroundColor = ta.getColor(R.styleable.MiClockView_backgroundColor, Color.parseColor("#237EAD"));
        ...
        /* 小时文本字体大小 */
        float mTextSize = ta.getDimension(R.styleable.MiClockView_textSize, Miclock_Utils.sp2px(context, 14));
        ta.recycle();
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        float mDefaultPadding = 0.12f * mRadius;//根据比例确定默认padding大小
